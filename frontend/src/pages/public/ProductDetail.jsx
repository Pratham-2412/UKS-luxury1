...
const ProductDetail = () => {
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] text-[#f0ece4] font-sans pt-28 sm:pt-32">

      {/* ── Breadcrumb & Back Link ── */}
      <div className="max-w-[1400px] mx-auto px-[clamp(1.5rem,5vw,5rem)] mb-6 sm:mb-8">
        <Link to="/shop" className="inline-flex items-center gap-2 text-[0.65rem] tracking-[0.2em] uppercase text-[#c4a064] hover:opacity-70 transition-opacity animate-fade-up">
          ← Back to Shop
        </Link>
      </div>
